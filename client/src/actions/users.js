...
export const postUser = (form) => (dispatch) => {
    ...
    return api.postUser(form).then(
        (payload) => {
            ...
            dispatch(push('/'))
            messageActions.addSuccessMessage(constants.MESSAGE_USER_POST_SUCCESS)(dispatch)
        },
        (error) => {
...
export const getUser = (id, token) => (dispatch) => {
    ...
    return api.getUser(id, token).then(
        (payload) => {
            ...
            messageActions.addSuccessMessage(constants.MESSAGE_USER_GET_SUCCESS)(dispatch)
        },
        (error) => {
